...
$sql= "insert into work_std (localtime2, carType1, item_index_no, itemNo1, itemName1, machineName1, materialName1, materialGrade1, materialColor1, nozzle1, sHeater1, sHeater2, sHeater3, sHeater4, nozzle2, 
		...
		values ('".date("Y-m-d")."', '".$_POST["carType1"]."', '".$_POST["item_index_no"]."', '".$_POST["itemNo1"]."', '".$_POST["itemName1"]."', '".$_POST["machineName1"]."', '".$_POST["materialName1"]."', '".$_POST["materialGrade1"]."', '".$_POST["materialColor1"]."', 
...
<script type="text/javascript">
		opener.document.location.href="/work_std(kp).php"
		self.close();
	</script>