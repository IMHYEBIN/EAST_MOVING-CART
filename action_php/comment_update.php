...
for ($countA = 1; $countA < 11; $countA++) {
	$countR = $countA - 1;
		...
		if ($comment_POST != null) {
			$sql = "update ar1 set a" . $countR . " = '" . $data_POST . "' where id = " . $comment_value;
		...
		if ($data_POST != null) {
			$sql01 = "update ar2 set a" . $countR . " = '" . $comment_POST . "'where id = " . $comment_value;
...
<script type="text/javascript">
	opener.document.location.href = "/comment.php?currentPage=<?php echo $comment_value ?>"
	self.close(); //본인창 닫기
</script>