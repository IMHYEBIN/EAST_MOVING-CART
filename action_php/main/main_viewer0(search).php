	...
	<section>
		<div style="float:left; padding-left: 340px; width: 1200px; height: 50px; position:relative;">
			<h3><span class="accent">생산 수량:</span> <?php echo number_format($sumcount, 0); ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				...
				<input type="button" value="검사기준 입력하기" onclick="window.open('/action_php/main/insert_inspection0.php')">
			</h3>
		</div>
		...
		<section style="float:left;">
			<table width="1910px">
				<thead>
					...
					<tr>
						<td colspan="2" bgcolor="#EAEAEA"><span class="strong">DIM⑤</span></td>
						<td colspan="2" bgcolor="#EAEAEA">
							<?php echo $data5_min; ?> mm ~ <?php echo $data5_max; ?> mm</td>
						<!--검사 기준치 minSpec5 ~ maxSpec5 단위= mm -->
						<td colspan="2" bgcolor="#EAEAEA"><?php echo $result007; ?></td>
					</tr>
					<tr>
						<td colspan="2" bgcolor="#EAEAEA"><span class="strong">DIM⑥</span></td>
						<td colspan="2" bgcolor="#EAEAEA">
						...
						<!--검사 기준치 minSpec5 ~ maxSpec5 단위= mm -->
						<td colspan="2" bgcolor="#EAEAEA"><?php echo $result008; ?></td>
					</tr>
					<tr>
						<td colspan="2" bgcolor="#EAEAEA"><span class="strong">DIM⑦</span></td>
						<td colspan="2" bgcolor="#EAEAEA">
						...
						<!--검사 기준치 minSpec5 ~ maxSpec5 단위= mm -->
						<td colspan="2" bgcolor="#EAEAEA"><?php echo $result009; ?></td>
					</tr>
					<tr>
						<td colspan="2" bgcolor="#EAEAEA"><span class="strong">DIM⑧</span></td>
						<td colspan="2" bgcolor="#EAEAEA">
						...
						<!--검사 기준치 minSpec5 ~ maxSpec5 단위= mm -->
						<td colspan="2" bgcolor="#EAEAEA"><?php echo $result010; ?></td>
					</tr>
					<tr>
