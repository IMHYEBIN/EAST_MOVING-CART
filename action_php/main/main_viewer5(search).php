...
$result001 = $row3[18];			//미성형 검사 1항목
$result002 = 0;					//없음
$result003 = 0;					//없음
$result004 = $row3[16];			//치수검사 1항목
$result005 = $row3[17];			//치수검사 2항목
$result006 = $row3[18];			//치수검사 3항목
$result007 = 0;					//없음
	...
	<section>
		<div style="float:left; padding-left: 340px; width: 1200px; height: 50px; position:relative;">
			<h3><span class="accent">생산 수량:</span> <?php echo number_format($sumcount, 0); ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				...
				<input type="button" value="검사기준 입력하기" onclick="window.open('/action_php/main/insert_inspection5.php')">
			</h3>
		</div>
		<div style="float:right; padding-right:610px;">
			...
			<select id="item_id_num" onchange="location.href=this.value">
				...
				<option value="/action_php/main/main_viewer4(search).php">4) YC-2 컨넥터</option>
			</select>
		</div>
		<!-- 1번째 분활 화면 시작 -->
		<section style="float:left;">
			<table width="1910px">
				<thead>
					...
					<tr>
						<td colspan="2" bgcolor="#EFF7FF"><span class="strong">외관검사 1</span></td>
						<td colspan="2"><?php if ($shape1_check == 0) {
											echo "무검사";
										} else {
											echo "유검사";
										} ?>
					...
					<tr>
						<td colspan="2" bgcolor="#EFF7FF"><span class="strong">외관검사 2</span></td>
						<td colspan="2"><?php if ($shape2_check == 0) {
											echo "무검사";
										} else {
											echo "유검사";
										} ?>
					...
					<tr>
						<td colspan="2" bgcolor="#EFF7FF"><span class="strong">외관검사 3</span></td>
						<td colspan="2"><?php if ($shape3_check == 0) {
											echo "무검사";
										} else {
											echo "유검사";
										} ?>
					...
					<tr>
						<td colspan="2" bgcolor="#EFF7FF"><span class="strong">DIM①</span></td>
						<td colspan="2">
