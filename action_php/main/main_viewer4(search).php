...
$sql1 = "select * from main_viewer where item_id_num = 4 order by id desc limit 3"; 																							// 문구 보기
	...
	<section>
		<div style="float:left; padding-left: 340px; width: 1200px; height: 50px; position:relative;">
			<h3><span class="accent">생산 수량:</span> <?php echo number_format($sumcount, 0); ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				...
				<input type="button" value="검사기준 입력하기" onclick="window.open('/action_php/main/insert_inspection4.php')">
			</h3>
		</div>
