...
setcookie('data1_min', $_POST["data1_min"], time() + 3600, '/');
setcookie('data1_max', $_POST["data1_max"], time() + 3600, '/');
setcookie('data2_min', $_POST["data2_min"], time() + 3600, '/');
setcookie('data2_max', $_POST["data2_max"], time() + 3600, '/');
setcookie('data3_min', $_POST["data3_min"], time() + 3600, '/');
setcookie('data3_max', $_POST["data3_max"], time() + 3600, '/');
setcookie('data4_min', $_POST["data4_min"], time() + 3600, '/');
setcookie('data4_max', $_POST["data4_max"], time() + 3600, '/');
setcookie('data5_min', $_POST["data5_min"], time() + 3600, '/');
setcookie('data5_max', $_POST["data5_max"], time() + 3600, '/');
setcookie('data6_min', $_POST["data6_min"], time() + 3600, '/');
setcookie('data6_max', $_POST["data6_max"], time() + 3600, '/');
setcookie('data7_min', $_POST["data7_min"], time() + 3600, '/');
setcookie('data7_max', $_POST["data7_max"], time() + 3600, '/');
setcookie('data8_min', $_POST["data8_min"], time() + 3600, '/');
setcookie('data8_max', $_POST["data8_max"], time() + 3600, '/');
setcookie('data9_min', $_POST["data9_min"], time() + 3600, '/');
setcookie('data9_max', $_POST["data9_max"], time() + 3600, '/');
setcookie('data10_min', $_POST["data10_min"], time() + 3600, '/');
setcookie('data10_max', $_POST["data10_max"], time() + 3600, '/');
setcookie('vcComment1', $_POST["vcComment1"], time() + 3600, '/');
setcookie('vcComment2', $_POST["vcComment2"], time() + 3600, '/');
setcookie('vcComment3', $_POST["vcComment3"], time() + 3600, '/');
setcookie('vcComment4', $_POST["vcComment4"], time() + 3600, '/');
setcookie('vcRevision1', $_POST["vcRevision1"], time() + 3600, '/');
setcookie('vcRevision2', $_POST["vcRevision2"], time() + 3600, '/');
setcookie('vcRevision_date1', $_POST["vcRevision_date1"], time() + 3600, '/');
setcookie('vcRevision_date2', $_POST["vcRevision_date2"], time() + 3600, '/');
