...
setcookie('item_index_no', $_POST["item_index_no"], time() + 10, '/');
$search = $_POST["item_index_no"];

$sql = "select * from work_std where item_index_no like '".$search."' order by id desc limit 3"; 																							// 문구 보기
...
<head>
  ...
  <title>성형 조건표 관리</title>
  <link href="/css/성형 조건표 스타일.css" rel="stylesheet" type="text/css">
</head>
<body>
  <section>
    <article>
      <table width=1900px height=800px>
        <thead>
        <form method="post" id="search" action="/work_std(kp).php" target="_self">
          <tr>
            <th colspan="47"><h2>사출 성형 작업 표준서</h2></th>
            <th colspan="13"><select name="item_index_no" id="search">
              <option value="0">0) LCA</option>
              <option value="1">1) UCA</option>
              <option value="2">2) RADIUS</option>
              <option value="3">3) 아이템4</option>
	          <input type="submit" id="search" value="조회하기"></form></th>
          </tr>
        </thead>
          <tr>
          <form method="post" action="action_php/work_std_insert(kp).php" target="_blank">
          <input type="hidden" name="localtime2" id="localtime2" value="<?php echo date('Y-m-d'); ?>">
            <th colspan="4" bgcolor="#C4DEFF">차종</th>
            <th colspan="14" bgcolor="#C4DEFF">품번</th>
            <th colspan="14" bgcolor="#C4DEFF">품명</th>
            <th colspan="6" bgcolor="#C4DEFF">설비명</th>
            <th colspan="6" bgcolor="#C4DEFF">원재료명</th>
            <th colspan="6" bgcolor="#C4DEFF">GRADE</th>
            <th colspan="6" bgcolor="#C4DEFF">색상</th>
          </tr>
          <tr>
            <td colspan="4"><input type="text" size="4" name="carType1" value="<?php echo $row[2]; ?>" required></td>           <!-- carType = 차종 -->
            <td colspan="14"><input type="text" size="10" name="item_index_no" placeholder="*)동일숫자 기재요"><input type="text" size="10" name="itemNo1" value="<?php echo $row[4]; ?>" required></td>           <!-- itemNo1 = 품번 call-->
          ...
          <tr>
            ...
            <th colspan="4" rowspan="22" bgcolor="#C4DEFF">성형<br>필수<br>조건<br>기재</th>
            <th colspan="12" rowspan="2" bgcolor="#C4DEFF">항 목</th>
            <th colspan="30" bgcolor="#C4DEFF">관리기준</th>
            <th colspan="14" bgcolor="#C4DEFF">관리담당</th>
          </tr>
          <tr>
            <th colspan="15" bgcolor="#EBF7FF">하절기</th>
            <th colspan="15" bgcolor="#EBF7FF">동절기</th>
            <th colspan="5" bgcolor="#EBF7FF">입력담당</th>
            <th colspan="5" bgcolor="#EBF7FF">확인담당</th>
          </tr>
          <tr>
            <th colspan="5" rowspan="4" bgcolor="#EBF7FF">온 도</th>
            <th colspan="7" rowspan="2" bgcolor="#EBF7FF">실린더<br>±10(℃)</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#C4DEFF">구 분</th>
            <th colspan="3" bgcolor="#C4DEFF">1차</th>
            <th colspan="3" bgcolor="#C4DEFF">2차</th>
            <th colspan="3" bgcolor="#C4DEFF">3차</th>
            <th colspan="3" bgcolor="#C4DEFF">4차</th>
            <th colspan="3" bgcolor="#C4DEFF">5차</th>
            <th colspan="3" bgcolor="#C4DEFF">1차</th>
            <th colspan="3" bgcolor="#C4DEFF">2차</th>
            <th colspan="3" bgcolor="#C4DEFF">3차</th>
            <th colspan="3" bgcolor="#C4DEFF">4차</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">사출압력(Kgf/㎤) ±5</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">사출속도(%) ±5</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">사출위치(mm) ±5</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">보압(Kgf/㎤) ±5</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">보압속도(%) ±5</th>
          ...
          <tr>
            <th colspan="12" bgcolor="#EBF7FF">건조 시간 / 건조 온도</th>
          ...
          <tr>
            ...
            <th colspan="12" bgcolor="#EBF7FF">초기조건 허용불량(Shot)</th>
            <td colspan="30"><input type="text" size="5" name="preShot1" value="<?php echo $row[84]; ?>">shot</td>             <!--허용불량 폐기 기준-->
          </tr>
          </div>
          <tr>
            <th colspan="4" rowspan="5" bgcolor="#FFE5C2">준수사항</th>
            <th colspan="24" align="left" class="in"> 1. 이형제 사용금지</th>
            <th colspan="3" rowspan="5" bgcolor="#C4DEFF">표준<br>변경<br>이력</th>
            <th colspan="4" bgcolor="#C4DEFF">순번</th>          
            <th colspan="6" bgcolor="#C4DEFF">변경일자</th>
            <th colspan="12" bgcolor="#C4DEFF">변경 내용</th>
            <th colspan="10" bgcolor="#C4DEFF">조회 / 저장</th>
          </tr>
          <tr>
            <th colspan="24" align="left" class="in">2. 작업 시작전 냉각수 및 온수 순환 상태 확인.</th>
            <td colspan="4"><input type="text" size="5" name="revision1" required></td>
            <td colspan="6"><input type="date" id='currentTime' name="revisionDate1" required></td>
            <td colspan="12"><input type="text" size="30" name="revisionReason1" required></td>
            <td colspan="10"><input type="submit" value="저장하기"></form></td>
          </tr>
          <tr>
            <th colspan="24" align="left" class="in">3.초기 생산시 최초 작업분 5쇼트는 폐기할 것.</th>
            <td colspan="4"><?php echo $row[85]; ?></td>                                                                  <!--최근 저장된 마지막이 상단에...-->
            <td colspan="6"><?php echo $row[86]; ?></td>
            <td colspan="12"><?php echo $row[87]; ?></td>
            <td colspan="10"><form action="/action_php/injection_search.php" method="post" target="_blank"><input type="hidden" name="correctMatch" value="<?php echo $row[0]; ?>"><input type="submit" value="조회하기"></form></td>
          </tr>
          <tr>
            <th colspan="24" align="left" class="in">4. 양산 시작전 초품상태 이상 유무 확인 후 작업 실시.</th>
            <td colspan="4"><?php $row = mysqli_fetch_array($res); echo $row[85]; ?></td>                                                                  <!--최근 -1 값 불러오기...-->
            <td colspan="6"><?php echo $row[86]; ?></td>
            <td colspan="12"><?php echo $row[87]; ?></td>
            <td colspan="10"><form action="/action_php/injection_search.php" method="post" target="_blank"><input type="hidden" name="correctMatch" value="<?php echo $row[0]; ?>"><input type="submit" value="조회하기"></form></td>
          </tr>
          <tr>
            <th colspan="24" align="left" class="in"><span class="redtext">☞ 이상 발생시 작업을 중단하고 즉시 관리자에게 보고 후 조치를 받을 것.</th>
            <td colspan="4"><?php $row = mysqli_fetch_array($res); echo $row[85]; ?></td>                                                                  <!--최근 -2 값 불러오기...-->
            <td colspan="6"><?php echo $row[86]; ?></td>
            <td colspan="12"><?php echo $row[87]; ?></td>
            <td colspan="10"><form action="/action_php/injection_search.php" method="post" target="_blank"><input type="hidden" name="correctMatch" value="<?php echo $row[0]; ?>"><input type="submit" value="조회하기"></form></td>
          </tr>
